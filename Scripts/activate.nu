...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Blaq_Jesus\jay_kay_dp\Django_projects\jay_kay'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Blaq_Jesus\jay_kay_dp\Django_projects\jay_kay\Scripts\deactivate.nu'
